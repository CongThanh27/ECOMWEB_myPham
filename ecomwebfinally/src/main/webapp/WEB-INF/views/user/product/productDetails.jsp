					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>	
									...
									<li class="active"><img src="${imgUrl1}" alt="" data-image="${imgUrl1}"></li>
						...
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url(${imgUrl})"></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col">
					<div class="tabs_container">
						<ul class="tabs d-flex flex-sm-row flex-column align-items-left align-items-md-center justify-content-center">
							...
							<li class="tab" data-active-tab="tab_3"><span>Reviews ( ${slreview} )</span></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div id="tab_2" class="tab_container">
						<div class="row">
							<div class="col additional_info_col">
								...
								<p>COLOR:<span>Trong suốt</span></p>
								<p>Dung tích<span>150ml</span></p>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-lg-6 reviews_col">
								...
								<div class="user_review_container d-flex flex-column flex-sm-row">
									<div class="user">
										<div class="user_pic">
											<img width="70px" height="70px" style=" border-radius: 50%;" src="${imgUser}" alt="">
										</div>
									...
									<div class="review">
										...
										<div class="user_name">${review.fistname} ${review.lastname} </div>
										<p>${review.content}.</p>
									</div>
								</div>
								</c:forEach>
